...
import classes from '../DataWithPercentagesAndAGraph/dataWithPercentagesAndAGraph.module.scss';
...
const DataWithPercentagesAndAGraphUnregisteredVisitors = () => {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      const [{ data: { platformList } },
        ...
        Api.topPlatformsUnregisteredUsers({
          startDate: startDate || oneMountAgo,
          endDate: endDate || endOfMonth,
        }),
        Api.topCountryUnregisteredUsers({
          startDate: startDate || oneMountAgo,
          endDate: endDate || endOfMonth,
        }),
        Api.topCityUnregisteredUsers({
          startDate: startDate || oneMountAgo,
          endDate: endDate || endOfMonth,
        }),
        Api.topViewsUnregisteredUsers({
          startDate: startDate || oneMountAgo,
          endDate: endDate || endOfMonth,
        }),
      ]);
...
export default DataWithPercentagesAndAGraphUnregisteredVisitors;
